...
DATABASES = {
    'default': {
        ...
        'NAME': 'score',                      # Or path to database file if using sqlite3.
        'USER': 'animkim',                      # Not used with sqlite3.
...
SECRET_KEY = 'kobst$lk0k&r5t=_3u#nqbl$qfpyw%rk(wg9&^((64h@5!q6fk'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'store.context_processors.media'
)
